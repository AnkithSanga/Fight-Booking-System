...
from FlightBooking.models import Users        # i have considered projectname as the name of our project.
...
def register(request):
    ...
    if request.method=="POST":
        ...
        if check_user :
            ...
            profile=Users(user_id=user_id,username=username,email=email,password=password,gender=gender)       #saving the details into model or database created 
            profile.save() 
            registered=True
