...
from FlightBooking.models import Users       
...
def register(request):
    ...
    if request.method=="POST":
        ...
        if check_user :
            ...
            profile=Users(user_id=user_id,username=username,email=email,password=password)       #saving the details into model or database created 
            profile.save() 
            registered=True
